...
%
%  설계
%     upper_body_model.m 의 오프셋에 배율을 곱해 stride_modeling 을 재생성한다.
...
if ~exist('BASE_DIR','var')
    % build_dataset.m 이 만든 .mat 폴더로 바꿔 주십시오.
...
src = fileread(fullfile(BASE_DIR, 'upper_body_model.m'));
