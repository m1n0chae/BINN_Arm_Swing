...
matlab_data_prep.py
-------------------
Utilities that safely parse HDF5-based MATLAB .mat files into Python
dict/ndarray structures and load/dump the requested top-level structs.
...
- print_mat_tree(path)  # inspect the internal tree structure of a file

Compatibility:
- Supports the MATLAB v7.3 (HDF5) format. (Requires: pip install h5py)
"""
