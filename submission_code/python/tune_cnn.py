...
# -----------------------------------------------------------
# [Model definition] 1D CNN Regressor
# -----------------------------------------------------------
...
# max_params is informational; the internal 250K-350K range takes precedence
...
# ---- CNN search space (channels raised to reach 250K-350K parameters) ----
channel_configs = [
    [128, 128, 64],
    [256, 128, 64],
    [128, 256, 128],
    [64, 128, 256, 128],
    [128, 256, 256, 128],  # larger model added
]
kernel_configs = [
    [7, 5, 3],
    [5, 5, 3],
...
for trial in range(1, args.trials + 1):
    ...
    # 1. Random sampling (repeat until the constraint is met)
    attempt = 0
    while True:
        attempt += 1
        ...
        # only 250K-350K parameter counts pass
